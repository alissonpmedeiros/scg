...
from controllers import MecController
            ...
            if mec.id == mec_id:
                for service in mec.services_set:
                    if not service.is_mobile:
                        ...
                        removed_service = MecController.remove_service(
                            mec_set,  
                            mec, 
                            service
                        )
    ...
    def solidarity(mec_set: List[Mec], mec_id: str, service: VrService, sucessful_migrations: int, unsuccessful_migrations: int):
        ...
        while victim_service_set:
            ...
            while True:
                ...
                if mec_set[victim_mec_index].id != mec_id and MecController.check_deployment(
                    mec_set=mec_set,
                    mec_id=mec_set[victim_mec_index],
                    service=removed_service
                ):
