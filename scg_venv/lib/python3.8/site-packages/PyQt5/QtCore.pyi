...
class Qt(PyQt5.sip.simplewrapper):
    ...
    class KeyboardModifiers(PyQt5.sip.simplewrapper):
    ...
    class MouseButtons(PyQt5.sip.simplewrapper):
    ...
    class Orientations(PyQt5.sip.simplewrapper):
    ...
    class Alignment(PyQt5.sip.simplewrapper):
    ...
    class WindowFlags(PyQt5.sip.simplewrapper):
    ...
    class WindowStates(PyQt5.sip.simplewrapper):
    ...
    class ImageConversionFlags(PyQt5.sip.simplewrapper):
    ...
    class DockWidgetAreas(PyQt5.sip.simplewrapper):
    ...
    class ToolBarAreas(PyQt5.sip.simplewrapper):
    ...
    class InputMethodQueries(PyQt5.sip.simplewrapper):
    ...
    class DropActions(PyQt5.sip.simplewrapper):
    ...
    class ItemFlags(PyQt5.sip.simplewrapper):
    ...
    class MatchFlags(PyQt5.sip.simplewrapper):
    ...
    class TextInteractionFlags(PyQt5.sip.simplewrapper):
    ...
    class InputMethodHints(PyQt5.sip.simplewrapper):
    ...
    class TouchPointStates(PyQt5.sip.simplewrapper):
    ...
    class GestureFlags(PyQt5.sip.simplewrapper):
    ...
    class ScreenOrientations(PyQt5.sip.simplewrapper):
    ...
    class FindChildOptions(PyQt5.sip.simplewrapper):
    ...
    class ApplicationStates(PyQt5.sip.simplewrapper):
    ...
    class Edges(PyQt5.sip.simplewrapper):
    ...
    class MouseEventFlags(PyQt5.sip.simplewrapper):
...
class QAbstractEventDispatcher(QObject):
    ...
    class TimerInfo(PyQt5.sip.simplewrapper):
...
class QModelIndex(PyQt5.sip.simplewrapper):
...
class QPersistentModelIndex(PyQt5.sip.simplewrapper):
...
class QAbstractItemModel(QObject):
    ...
    class CheckIndexOptions(PyQt5.sip.simplewrapper):
...
class QAbstractNativeEventFilter(PyQt5.sip.simplewrapper):
...
class QBasicTimer(PyQt5.sip.simplewrapper):
...
class QBitArray(PyQt5.sip.simplewrapper):
...
class QIODevice(QObject):
    ...
    class OpenMode(PyQt5.sip.simplewrapper):
...
class QByteArray(PyQt5.sip.simplewrapper):
    ...
    class Base64Options(PyQt5.sip.simplewrapper):
    ...
    class FromBase64Result(PyQt5.sip.simplewrapper):
    ...
    def __add__(self, a1: typing.Union['QByteArray', bytes, bytearray], a2: typing.Union['QByteArray', bytes, bytearray]) -> 'QByteArray': ...
    @staticmethod
...
class QByteArrayMatcher(PyQt5.sip.simplewrapper):
...
class QCalendar(PyQt5.sip.simplewrapper):
    ...
    class YearMonthDay(PyQt5.sip.simplewrapper):
...
class QCborError(PyQt5.sip.simplewrapper):
...
class QCborStreamWriter(PyQt5.sip.simplewrapper):
...
class QCborStreamReader(PyQt5.sip.simplewrapper):
...
class QCollatorSortKey(PyQt5.sip.simplewrapper):
...
class QCollator(PyQt5.sip.simplewrapper):
...
class QCommandLineOption(PyQt5.sip.simplewrapper):
...
class QCommandLineParser(PyQt5.sip.simplewrapper):
...
class QCryptographicHash(PyQt5.sip.simplewrapper):
...
class QDataStream(PyQt5.sip.simplewrapper):
...
class QDate(PyQt5.sip.simplewrapper):
...
class QTime(PyQt5.sip.simplewrapper):
...
class QDateTime(PyQt5.sip.simplewrapper):
...
class QDeadlineTimer(PyQt5.sip.simplewrapper):
...
class QDir(PyQt5.sip.simplewrapper):
    ...
    class Filters(PyQt5.sip.simplewrapper):
    ...
    class SortFlags(PyQt5.sip.simplewrapper):
...
class QDirIterator(PyQt5.sip.simplewrapper):
    ...
    class IteratorFlags(PyQt5.sip.simplewrapper):
...
class QEasingCurve(PyQt5.sip.simplewrapper):
...
class QElapsedTimer(PyQt5.sip.simplewrapper):
...
class QEventLoop(QObject):
    ...
    class ProcessEventsFlags(PyQt5.sip.simplewrapper):
...
class QEventLoopLocker(PyQt5.sip.simplewrapper):
...
class QFileDevice(QIODevice):
    ...
    class Permissions(PyQt5.sip.simplewrapper):
    ...
    class FileHandleFlags(PyQt5.sip.simplewrapper):
...
class QFileInfo(PyQt5.sip.simplewrapper):
...
class QItemSelectionRange(PyQt5.sip.simplewrapper):
...
class QItemSelectionModel(QObject):
    ...
    class SelectionFlags(PyQt5.sip.simplewrapper):
...
class QItemSelection(PyQt5.sip.simplewrapper):
...
class QJsonParseError(PyQt5.sip.simplewrapper):
...
class QJsonDocument(PyQt5.sip.simplewrapper):
...
class QJsonValue(PyQt5.sip.simplewrapper):
...
class QLibrary(QObject):
    ...
    class LoadHints(PyQt5.sip.simplewrapper):
...
class QLibraryInfo(PyQt5.sip.simplewrapper):
...
class QLine(PyQt5.sip.simplewrapper):
...
class QLineF(PyQt5.sip.simplewrapper):
...
class QLocale(PyQt5.sip.simplewrapper):
    ...
    class NumberOptions(PyQt5.sip.simplewrapper):
    ...
    class DataSizeFormats(PyQt5.sip.simplewrapper):
...
class QLockFile(PyQt5.sip.simplewrapper):
...
class QMessageLogContext(PyQt5.sip.simplewrapper):
...
class QMessageLogger(PyQt5.sip.simplewrapper):
...
class QLoggingCategory(PyQt5.sip.simplewrapper):
...
class QMargins(PyQt5.sip.simplewrapper):
...
class QMarginsF(PyQt5.sip.simplewrapper):
...
class QMessageAuthenticationCode(PyQt5.sip.simplewrapper):
...
class QMetaMethod(PyQt5.sip.simplewrapper):
...
class QMetaEnum(PyQt5.sip.simplewrapper):
...
class QMetaProperty(PyQt5.sip.simplewrapper):
...
class QMetaClassInfo(PyQt5.sip.simplewrapper):
...
class QMetaType(PyQt5.sip.simplewrapper):
    ...
    class TypeFlags(PyQt5.sip.simplewrapper):
...
class QMimeDatabase(PyQt5.sip.simplewrapper):
...
class QMimeType(PyQt5.sip.simplewrapper):
...
class QMutexLocker(PyQt5.sip.simplewrapper):
...
class QMutex(PyQt5.sip.simplewrapper):
...
class QRecursiveMutex(PyQt5.sip.simplewrapper):

    def __init__(self) -> None: ...


class QSignalBlocker(PyQt5.sip.simplewrapper):
...
class QMetaObject(PyQt5.sip.simplewrapper):

    class Connection(PyQt5.sip.simplewrapper):
...
class QGenericArgument(PyQt5.sip.simplewrapper): ...


class QGenericReturnArgument(PyQt5.sip.simplewrapper): ...


class QOperatingSystemVersion(PyQt5.sip.simplewrapper):
...
class QPoint(PyQt5.sip.simplewrapper):
...
class QPointF(PyQt5.sip.simplewrapper):
    ...
    def __eq__(self, other: object): ...
    def __ne__(self, other: object): ...
    def __add__(self, p1: typing.Union['QPointF', QPoint], p2: typing.Union['QPointF', QPoint]) -> 'QPointF': ...
    def __sub__(self, p1: typing.Union['QPointF', QPoint], p2: typing.Union['QPointF', QPoint]) -> 'QPointF': ...
    @typing.overload
    ...
    def __truediv__(self, p: typing.Union['QPointF', QPoint], c: float) -> 'QPointF': ...
...
class QProcessEnvironment(PyQt5.sip.simplewrapper):
...
class QRandomGenerator(PyQt5.sip.simplewrapper):
...
class QReadWriteLock(PyQt5.sip.simplewrapper):
...
class QReadLocker(PyQt5.sip.simplewrapper):
...
class QWriteLocker(PyQt5.sip.simplewrapper):
...
class QRect(PyQt5.sip.simplewrapper):
...
class QRectF(PyQt5.sip.simplewrapper):
...
class QRegExp(PyQt5.sip.simplewrapper):
...
class QRegularExpression(PyQt5.sip.simplewrapper):
    ...
    class PatternOptions(PyQt5.sip.simplewrapper):
    ...
    class MatchOptions(PyQt5.sip.simplewrapper):
...
class QRegularExpressionMatch(PyQt5.sip.simplewrapper):
...
class QRegularExpressionMatchIterator(PyQt5.sip.simplewrapper):
...
class QResource(PyQt5.sip.simplewrapper):
...
class QSemaphore(PyQt5.sip.simplewrapper):
...
class QSemaphoreReleaser(PyQt5.sip.simplewrapper):
...
class QSize(PyQt5.sip.simplewrapper):
...
class QSizeF(PyQt5.sip.simplewrapper):
...
class QStandardPaths(PyQt5.sip.simplewrapper):
    ...
    class LocateOptions(PyQt5.sip.simplewrapper):
...
class QStorageInfo(PyQt5.sip.simplewrapper):
...
class QSystemSemaphore(PyQt5.sip.simplewrapper):
...
class QTemporaryDir(PyQt5.sip.simplewrapper):
...
class QTextBoundaryFinder(PyQt5.sip.simplewrapper):
    ...
    class BoundaryReasons(PyQt5.sip.simplewrapper):
...
class QTextCodec(PyQt5.sip.wrapper):
    ...
    class ConversionFlags(PyQt5.sip.simplewrapper):
    ...
    class ConverterState(PyQt5.sip.simplewrapper):

        def __init__(self, flags: typing.Union['QTextCodec.ConversionFlags', 'QTextCodec.ConversionFlag'] = ...) -> None: ...

    def __init__(self) -> None: ...

    def convertFromUnicode(self, in_: PyQt5.sip.array[str], state: 'QTextCodec.ConverterState') -> QByteArray: ...
    def convertToUnicode(self, in_: PyQt5.sip.array[bytes], state: 'QTextCodec.ConverterState') -> str: ...
    ...
    @typing.overload
    def toUnicode(self, in_: PyQt5.sip.array[bytes], state: typing.Optional['QTextCodec.ConverterState'] = ...) -> str: ...
...
class QTextStream(PyQt5.sip.simplewrapper):
    ...
    class NumberFlags(PyQt5.sip.simplewrapper):
...
class QTextStreamManipulator(PyQt5.sip.simplewrapper): ...
...
class QTimeZone(PyQt5.sip.simplewrapper):
    ...
    class OffsetData(PyQt5.sip.simplewrapper):
...
class QTranslator(QObject):
    ...
    def loadFromData(self, data: PyQt5.sip.array[bytes], directory: str = ...) -> bool: ...
    @typing.overload
...
class QUrl(PyQt5.sip.simplewrapper):
    ...
    class FormattingOptions(PyQt5.sip.simplewrapper):

        @typing.overload
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, f: typing.Union['QUrl.FormattingOptions', 'QUrl.UrlFormattingOption', 'QUrl.ComponentFormattingOption']) -> None: ...
        ...
        def __xor__(self, f: typing.Union['QUrl.FormattingOptions', 'QUrl.UrlFormattingOption', 'QUrl.ComponentFormattingOption']) -> 'QUrl.FormattingOptions': ...
        def __or__(self, f: typing.Union['QUrl.FormattingOptions', 'QUrl.UrlFormattingOption', 'QUrl.ComponentFormattingOption']) -> 'QUrl.FormattingOptions': ...
        def __index__(self) -> int: ...
        def __int__(self) -> int: ...
        def __ixor__(self, f: typing.Union['QUrl.FormattingOptions', 'QUrl.UrlFormattingOption', 'QUrl.ComponentFormattingOption']) -> 'QUrl.FormattingOptions': ...
        def __ior__(self, f: typing.Union['QUrl.FormattingOptions', 'QUrl.UrlFormattingOption', 'QUrl.ComponentFormattingOption']) -> 'QUrl.FormattingOptions': ...
        def __iand__(self, mask: int) -> 'QUrl.FormattingOptions': ...

    class ComponentFormattingOptions(PyQt5.sip.simplewrapper):
    ...
    class UserInputResolutionOptions(PyQt5.sip.simplewrapper):
...
class QUrlQuery(PyQt5.sip.simplewrapper):
...
class QUuid(PyQt5.sip.simplewrapper):
...
class QVariant(PyQt5.sip.simplewrapper):
...
class QVersionNumber(PyQt5.sip.simplewrapper):
...
class QWaitCondition(PyQt5.sip.simplewrapper):
...
class QXmlStreamAttribute(PyQt5.sip.simplewrapper):
...
class QXmlStreamAttributes(PyQt5.sip.simplewrapper):
...
class QXmlStreamNamespaceDeclaration(PyQt5.sip.simplewrapper):
...
class QXmlStreamNotationDeclaration(PyQt5.sip.simplewrapper):
...
class QXmlStreamEntityDeclaration(PyQt5.sip.simplewrapper):
...
class QXmlStreamEntityResolver(PyQt5.sip.simplewrapper):
...
class QXmlStreamReader(PyQt5.sip.simplewrapper):
...
class QXmlStreamWriter(PyQt5.sip.simplewrapper):
...
class QSysInfo(PyQt5.sip.simplewrapper):
